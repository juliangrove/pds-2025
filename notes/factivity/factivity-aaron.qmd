...
![Left: ELPDs for the two models of the norming data from @degen_prior_2021's experiment 2a. Dotted line indicates estimated difference between the norming-discrete model and the norming-gradient model.](plots/norming_elpd.pdf){#fig:norming-elpds-pps}
...
To accommodate the novel type of index-sensitivity of *know*, the prior over indices encoded in the common ground must be updated:

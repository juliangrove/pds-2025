...
- *tall* is true of $x$ if height($x$) $\geq d_\text{tall}$ (context)
...
This gradience poses a theoretical challenge [@simons_observations_2007; @simons_what_2010; @simons_best_2017; @tonhauser_how_2018]. In this case study, we'll consider two hypotheses that PDS allows us to state precisely and test against the data:

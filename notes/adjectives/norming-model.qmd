...
This term undergoes several delta reductions. First, the `indices` rule extracts the height value from the discourse state. From [`Lambda.Delta`](https://juliangrove.github.io/pds/Lambda-Delta.html):

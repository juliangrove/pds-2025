...
Using the PDS rules from [Module 2](../pds-intro/syntax-meaning-compositionality.html),  we first combine "is" and "tall":
...
## The compilation pipeline: From lambda-terms to Stan

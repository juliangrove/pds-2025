...
expr = ["jo", "is", "tall"]
s1 = getSemantics @Adjectives 0 expr
...
# Scale-norming and Likelihood Models

## Two core model types

::: {.incremental}
1. **Scale-norming**: "How tall is Jo?"
   - Asks for degree on a scale
   - Direct degree inference

2. **Likelihood**: "How likely is it that Jo is tall?"
   - Metalinguistic judgment
   - Probabilistic reasoning about adjective application
:::
